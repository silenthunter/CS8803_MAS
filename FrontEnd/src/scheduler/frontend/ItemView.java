...
import scheduler.frontend.EventView.TimePickerFragment;
...
public class ItemView extends FragmentActivity {
	...
	private void writeEvent()
	{
		try
		{
			...
			//Get priority
			RadioButton radioLow = (RadioButton)findViewById(R.id.addEventRadioLow);
			RadioButton radioMed = (RadioButton)findViewById(R.id.addEventRadioMed);
			RadioButton radioHigh = (RadioButton)findViewById(R.id.addEventRadioHigh);
			
			short priority = Event.DEFAULT_PRIORITY;
			
			if(radioLow.isChecked()) priority = Event.LOW_PRIORITY;
			else if(radioMed.isChecked()) priority = Event.DEFAULT_PRIORITY;
			else if(radioHigh.isChecked()) priority = Event.HIGH_PRIORITY;
	...
	public static class TimePickerFragment extends DialogFragment implements TimePickerDialog.OnTimeSetListener
	{
		...
		public void onTimeSet(TimePicker view, int hourOfDay, int minute)
		{
			...
			if(args != null && args.containsKey("editText"))
			{
				...
				ItemView parentActivity = (ItemView)getActivity();
